...
## 迭代 1.7 - 多知识库支持功能 (2026年1月)

### 完成的功能
- **多知识库管理**
  - 实现知识库配置管理（KnowledgeBaseConfig）
  - 实现知识库信息管理（KnowledgeBaseInfo）
  - 支持动态添加、移除和启用/禁用知识库
  - 支持配置持久化和加载
...
### 技术细节
- 创建了`knowledge_base_manager.py`模块
- 更新了`vector_store.py`支持多集合
- 更新了`retriever.py`支持知识库过滤
- 更新了`main.py`集成多知识库功能
